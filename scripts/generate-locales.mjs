...
const it = base({
  ...
  'apiKeys.description': "Le chiavi API consentono ai servizi esterni (come Seerr) di autenticarsi con Friendarr e inviare lavori di download.",
  'apiKeys.label': 'Etichetta',
  'apiKeys.newKey': 'Nuova chiave API',
  'apiKeys.newKeyHint': 'Assegna un nome facile da ricordare per sapere a cosa serve.',
  ...
  'auth.authenticateToContinue': 'Inserisci la tua chiave API master per continuare.',
  'auth.authenticateToManageSettings': 'Autenticati per gestire le impostazioni',
  ...
  'auth.modalDescription': 'Inserisci la tua chiave API master per gestire la coda e le impostazioni.',
  ...
  'display.languageDescription': "Scegli la tua lingua preferita per l'interfaccia.",
  ...
  'general.description': 'Configura concorrenza, modalità test, logging e lingua.',
  'general.setupWizard': 'Riavvia procedura guidata',
  'general.title': 'Generale',
  'limits.bandwidthHint': 'Imposta a 0 per illimitato.',
  'limits.description': 'Configura concorrenza download, larghezza di banda e modalità test.',
  'limits.logLevel': 'Livello di log',
  'limits.logLevelDescription': 'Livello minimo di log per output console e buffer dei log.',
  ...
  'limits.testModeDescription': 'Se attivato, i download vengono saltati e i lavori sono contrassegnati come completati immediatamente.',
  'limits.testModeEnabled': 'La modalità test è attualmente attivata. I download vengono saltati.',
  'limits.title': 'Limiti',
  'logs.all': 'Tutti',
  ...
  'paths.completedHint': 'Directory principale per i download multimediali completati.',
  'paths.description': 'Configura dove vengono archiviati su disco i download incompleti e completati.',
  ...
  'paths.movieDirHint': 'Dove vengono posizionati i film. Predefinito: {completedPath}/movies.',
  'paths.title': 'Percorsi',
  'paths.tvDir': 'Directory serie TV',
  'paths.tvDirHint': 'Dove vengono posizionate le serie TV. Predefinito: {completedPath}/tv.',
  ...
  'schedules.description': 'Limita i download a giorni e finestre orarie specifici.',
  'schedules.end': 'Fine',
  'schedules.fri': 'Ven',
  'schedules.mon': 'Lun',
  ...
  'webhooks.description': 'Configura webhook per ricevere notifiche per gli eventi di download.',
  ...
  'webhooks.secretHint': 'Segreto opzionale per la verifica della firma del payload.',
  ...
  'wizard.next': 'Avanti',
  'wizard.skip': 'Salta',
  'wizard.step1.description': "Scegli la tua lingua preferita per l'interfaccia.",
  'wizard.step1.title': 'Passo 1: Lingua',
  'wizard.step2.description': "Genera la tua chiave API master. Questa chiave è necessaria per accedere alla dashboard.",
  'wizard.step2.keyHint': 'Genera una chiave casuale sicura. Salvala in un luogo sicuro — non può essere recuperata.',
  'wizard.step2.keyLabel': 'Chiave API',
  'wizard.step2.masterKeySet': 'Una chiave master è configurata sul server. Inseriscila qui sotto per accedere alla dashboard.',
  'wizard.step2.noMasterKey': "Nessuna chiave API master è configurata. Generane una qui sotto, poi clicca su Attiva per salvarla.",
  ...
  'wizard.step2.authFailed': 'Chiave master non valida. Controlla il tuo file .env e riprova.',
  'wizard.step3.completed': 'Percorso completati',
  'wizard.step3.completedHint': 'Directory principale per i media completati.',
  'wizard.step3.description': 'Configura dove vengono archiviati i download incompleti e completati.',
  'wizard.step3.incomplete': 'Percorso incompleti',
  'wizard.step3.incompleteHint': 'Directory per i file attualmente in download.',
  'wizard.step3.title': 'Passo 3: Posizioni',
  'wizard.step3.detail': 'I file vengono scaricati prima nel percorso incompleto, poi collegati al percorso completato in caso di successo. Imposta directory separate per film e serie TV.',
  'wizard.step1.detail': 'Friendarr supporta inglese, spagnolo, francese, tedesco, giapponese, cinese e portoghese.',
  'wizard.step2.detail': 'Questa chiave è utilizzata da Seerr e altri client per autenticarsi con Friendarr. Salvala in un luogo sicuro — non può essere recuperata.',
  'wizard.finish.title': 'Configurazione completata',
  'wizard.finish.detail': 'Friendarr è pronto. Prossimo: crea una pianificazione di download per controllare quando i download vengono eseguiti. Configura una libreria amica in Seerr per iniziare a inviare richieste.',
});
...
const nl = base({
  ...
  'apiKeys.description': 'API-sleutels stellen externe diensten (zoals Seerr) in staat om te authenticeren bij Friendarr en downloadtaken in te dienen.',
  'apiKeys.label': 'Label',
  'apiKeys.newKey': 'Nieuwe API-sleutel',
  'apiKeys.newKeyHint': 'Geef deze sleutel een gedenkwaardige naam zodat je weet waar hij voor is.',
  ...
  'auth.authenticateToContinue': 'Voer je master API-sleutel in om door te gaan.',
  'auth.authenticateToManageSettings': 'Authenticeer om instellingen te beheren',
  ...
  'auth.modalDescription': 'Voer je master API-sleutel in om de wachtrij en instellingen te beheren.',
  ...
  'general.description': 'Configureer gelijktijdigheid, testmodus, logging en taal.',
  ...
  'limits.description': 'Configureer downloadgelijktijdigheid, bandbreedte en testmodus.',
  'limits.logLevel': 'Logniveau',
  'limits.logLevelDescription': 'Minimaal logniveau voor console-uitvoer en de logbuffer.',
  'limits.maxBandwidth': 'Max bandbreedte (bytes/sec)',
  'limits.maxConcurrent': 'Max gelijktijdige downloads',
  'limits.testMode': 'Testmodus',
  'limits.testModeDescription': 'Indien ingeschakeld, worden downloads overgeslagen en taken direct als voltooid gemarkeerd.',
  'limits.testModeEnabled': 'Testmodus is momenteel ingeschakeld. Downloads worden overgeslagen.',
  ...
  'paths.description': 'Configureer waar onvoltooide en voltooide downloads op schijf worden opgeslagen.',
  ...
  'paths.movieDirHint': 'Waar films worden geplaatst. Standaard: {completedPath}/movies.',
  'paths.title': 'Paden',
  'paths.tvDir': 'TV-map',
  'paths.tvDirHint': 'Waar tv-series worden geplaatst. Standaard: {completedPath}/tv.',
  ...
  'schedules.description': 'Beperk downloads tot specifieke dagen en tijdvensters.',
  'schedules.end': 'Einde',
  'schedules.fri': 'Vrij',
  'schedules.mon': 'Maa',
  ...
  'webhooks.description': 'Configureer webhooks om meldingen te ontvangen voor downloadgebeurtenissen.',
  ...
  'webhooks.secretHint': 'Optioneel geheim voor handtekeningverificatie van de payload.',
  ...
  'wizard.step2.description': 'Genereer je master API-sleutel. Deze sleutel is vereist om toegang te krijgen tot het dashboard.',
  'wizard.step2.keyHint': 'Genereer een sterke willekeurige sleutel. Bewaar deze veilig — hij kan niet worden hersteld.',
  'wizard.step2.keyLabel': 'API-sleutel',
  'wizard.step2.masterKeySet': 'Er is een hoofdsleutel geconfigureerd op de server. Voer deze hieronder in om toegang te krijgen tot het dashboard.',
  'wizard.step2.noMasterKey': 'Geen master API-sleutel geconfigureerd. Genereer er hieronder een en klik op Activeren om hem op te slaan.',
  ...
  'wizard.step2.authFailed': 'Ongeldige hoofdsleutel. Controleer je .env-bestand en probeer opnieuw.',
  'wizard.step3.completed': 'Pad voltooide',
  'wizard.step3.completedHint': 'Hoofdmap voor voltooide media.',
  'wizard.step3.description': 'Configureer waar onvoltooide en voltooide downloads worden opgeslagen.',
  'wizard.step3.incomplete': 'Pad onvoltooide',
  'wizard.step3.incompleteHint': 'Map voor bestanden die momenteel worden gedownload.',
  'wizard.step3.title': 'Stap 3: Locaties',
  'wizard.step3.detail': 'Bestanden downloaden eerst naar het onvoltooide pad en worden bij succes gekoppeld aan het voltooide pad. Stel aparte mappen in voor films en tv-series.',
  'wizard.step1.detail': 'Friendarr ondersteunt Engels, Spaans, Frans, Duits, Japans, Chinees en Portugees.',
  'wizard.step2.detail': 'Deze sleutel wordt gebruikt door Seerr en andere clients om te authenticeren bij Friendarr. Bewaar deze veilig — hij kan niet worden hersteld.',
  'wizard.finish.title': 'Installatie voltooid',
  'wizard.finish.detail': 'Friendarr is klaar. Volgende: maak een downloadschema om te bepalen wanneer downloads worden uitgevoerd. Configureer een vriendbibliotheek in Seerr om verzoeken te verzenden.',
});

// ─── All locale codes matching Seerr ───────────────────────────────────────

const allLocales = [
  'ar', 'bg', 'ca', 'cs', 'da', 'de', 'el', 'en', 'es-MX', 'es', 'et', 'eu',
  'fi', 'fr', 'he', 'hi', 'hr', 'hu', 'it', 'ja', 'kab', 'ko', 'lb', 'lt',
  'nb-NO', 'nl', 'pl', 'pt-BR', 'pt-PT', 'ro', 'ru', 'sk', 'sl', 'sq', 'sr',
...
const haveTranslations = new Set([
  'en', 'es', 'es-MX', 'fr', 'de', 'ja', 'zh-Hans', 'pt-BR', 'it', 'nl',
]);

const havePartial = new Set([
  'zh-Hant', 'pt-PT',
]);
...
for (const locale of allLocales) {
  ...
  if (locale === 'es-MX') {
    data = JSON.parse(fs.readFileSync(path.join(localesDir, 'es.json'), 'utf8'));
  } else if (locale === 'es') {
    // Already exists
    continue;
  } else if (locale === 'en') {
    ...
    data = JSON.parse(fs.readFileSync(path.join(localesDir, 'zh-Hans.json'), 'utf8'));
    // Convert simplified -> traditional (minimal key adjustments)
    // We'll create a separate mapping in a second pass
  } else if (locale === 'pt-PT') {
    data = JSON.parse(fs.readFileSync(path.join(localesDir, 'pt-BR.json'), 'utf8'));
  } else {
